function [bf, nLL] = fit_4pmodel_macro
%parameters are (1)softmax, (2)lapse, (3)alpha, (4)bias
...
for m = 1:length(myrats)
    ...
    [initcond, bestfit, nLL{m}] = fit_bandit_model_4p(S, iters);
    [data] = gen_model_4p(S, bestfit);
    bf{m} = bestfit;
    if m==4
